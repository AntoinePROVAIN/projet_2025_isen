        ...
        <div className="authComponent_container w-full bg-white shadow-md rounded-lg p-6 mt-8">
            <div className='authComponent_content'>
                  <form onSubmit={handleSubmit}>
                    ...
                    <input type='text' id="siret" name='siret' value={siret} onChange={(e) => setSiret(e.target.value)} className='auth_input w-full mb-3 p-1 h-10 border rounded'/>
                    <label className="labels">Company's name</label>
                    <input type='text' id="name" name='name' value={nameCompany} onChange={(e) => setNameCompany(e.target.value)} className='auth_input w-full mb-3 p-1 h-10 border rounded'/>
                    ...
                    <input type='text' id="desc" name='desc' value={desc} onChange={(e) => setDesc(e.target.value)} className='auth_input w-full mb-3 p-1 h-10 border rounded'/>
